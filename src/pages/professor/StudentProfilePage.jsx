...
import { FiArrowLeft, FiBook, FiMapPin, FiUser, FiTarget, FiLock, FiBookOpen, FiSmile, FiCheck } from "react-icons/fi";
  ...
  if (error || !student) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-[var(--surface-alt)] dark:bg-[var(--surface)] p-6 text-center">
        <span className="text-5xl text-[var(--accent)]">{isLimitError ? <SlRocket /> : <FiSmile />}</span>
