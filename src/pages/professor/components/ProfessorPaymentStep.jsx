    ...
    return (
        <div className="space-y-8">
            ...
            <div className="max-w-xl mx-auto">
                <div
                    className="relative p-8 rounded-2xl border-2 border-[#6A11CB]/30 shadow-xl"
                    style={{
                        background: "linear-gradient(160deg, #f5f3ff 0%, #fdf0f7 100%)",
                ...
                >
                    ...
                    <div
                        ...
                        style={{ background: "linear-gradient(135deg, #2575FC, #6A11CB)" }}
                    />
                    ...
                    <div className="text-center mb-6 mt-2">
                        <span className="text-6xl font-black text-[#1a0e33]">18%</span>
                    ...
                    <div className="mt-6 p-4 rounded-xl bg-white/70 backdrop-blur-sm border border-[#6A11CB]/10">
                        <p className="text-xs font-semibold text-slate-500 mb-3 uppercase tracking-wider">
                            Example Breakdown
                        </p>
                        <div className="grid grid-cols-3 gap-2 text-center">
                            <div>
                                <p className="text-lg font-black text-[#1a0e33]">₹500</p>
                                <p className="text-xs text-slate-400">Session Fee</p>
                            </div>
                            <div>
                                <p className="text-lg font-black text-[#FF4E9B]">₹90</p>
                                <p className="text-xs text-slate-400">Platform (18%)</p>
                            </div>
                            <div>
                                <p className="text-lg font-black text-[#6A11CB]">₹410</p>
            ...
            <div className="max-w-xl mx-auto">
                <div className="p-4 rounded-xl bg-white border border-slate-200 text-sm text-slate-600 text-center">
                    ...
                    <span className="text-[#6A11CB] font-semibold cursor-pointer hover:underline">
                        Terms of Service
                    </span>{" "}
                    and the{" "}
                    <span className="text-[#6A11CB] font-semibold cursor-pointer hover:underline">
