...
export default function StudentDashboardUI() {
  ...
  // ── Persistent socket: connect once, stay alive for notifications ──
  useEffect(() => {
    if (!user) return
      ...
      `}>
          ...
          {NAV_ITEMS.map(({ id, label, icon: Icon }) => {
            ...
            return (
              ...
              >
                ...
                {id === "messages" && chatUnread > 0 && !active && (
        ...
        <div className="px-4 py-5 border-t border-white/15">
          <div className="flex items-center gap-3 mb-4 px-2">
            <div className="w-9 h-9 rounded-full bg-[var(--accent)] flex items-center justify-center font-bold text-sm shadow shrink-0">
