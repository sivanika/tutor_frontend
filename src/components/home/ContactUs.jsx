...
export default function ContactUs() {
  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden dark:bg-[var(--surface)]">
      {/* Background Blurs */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-[var(--primary)]/10 blur-[120px]" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-[var(--accent)]/10 blur-[120px]" />
      </div>

      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <span className="text-[var(--primary)] dark:text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3 block">
            Get in Touch
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8">
            <div className="group flex items-start gap-5 p-6 rounded-2xl bg-white/50 dark:bg-white/5 border border-slate-200/50 dark:border-white/10 hover:border-[var(--primary)]/30 dark:hover:border-[var(--accent)]/30 transition-colors backdrop-blur-sm">
              <div className="w-12 h-12 rounded-xl bg-purple-100 dark:bg-[var(--primary)]/20 flex items-center justify-center text-[var(--primary)] dark:text-[var(--accent)] shrink-0 group-hover:scale-110 transition-transform">
                <FiMail size={24} />
              </div>
              <div>
                ...
                <a href="mailto:vishidhacadamy@gmail.com" className="text-[var(--primary)] dark:text-[var(--accent)] font-medium hover:underline">
            ...
            <div className="group flex items-start gap-5 p-6 rounded-2xl bg-white/50 dark:bg-white/5 border border-slate-200/50 dark:border-white/10 hover:border-[var(--primary)]/30 dark:hover:border-[var(--accent)]/30 transition-colors backdrop-blur-sm">
              <div className="w-12 h-12 rounded-xl bg-blue-100 dark:bg-[var(--primary)]/20 flex items-center justify-center text-[var(--primary)] dark:text-blue-400 shrink-0 group-hover:scale-110 transition-transform">
                <FiMapPin size={24} />
              </div>
              <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:ring-2 focus:ring-[var(--primary)] dark:text-white outline-none transition-all placeholder:text-slate-400 dark:placeholder:text-slate-500"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:ring-2 focus:ring-[var(--primary)] dark:text-white outline-none transition-all resize-none placeholder:text-slate-400 dark:placeholder:text-slate-500"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 rounded-xl grad-bg text-white font-semibold text-lg shadow-lg shadow-[var(--primary)]/30 hover:shadow-xl hover:shadow-[var(--primary)]/40 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {loading ? (
